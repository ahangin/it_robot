...
public:
    ImageProjection() : deskewFlag(0)
    {
        ...
        pubExtractedCloud = nh.advertise<sensor_msgs::PointCloud2>(outputTopic, 1);
...
// ======================================================================================================================
    ...
    bool cachePointCloud(const sensor_msgs::PointCloud2ConstPtr &laserCloudMsg)
    {
        ...
        {
        pcl::moveFromROSMsg(currentCloudMsg, *rsLaserCloudIn);
        handle_pc_msg<RsPointXYZIRT, VelodynePointXYZIRT>(rsLaserCloudIn, laserCloudIn);
        add_ring<RsPointXYZIRT, VelodynePointXYZIRT>(rsLaserCloudIn, laserCloudIn);
        add_time<RsPointXYZIRT, VelodynePointXYZIRT>(rsLaserCloudIn, laserCloudIn);
        laserCloudIn->is_dense = true;
        // laserCloudIn->header.stamp = currentCloudMsg.header.stamp.toNSec() / 1000;
        }
        // ===============================================================================
        else
        {
    ...
    void projectPointCloud()
    {
        ...
        for (int i = 0; i < cloudSize; ++i)
        {
            ...
            if (sensor == SensorType::VELODYNE || sensor == SensorType::OUSTER|| sensor == SensorType::RS)
            {
